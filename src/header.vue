    ...
    <div class="head_container clearfix">
      ...
      <div class="head_list">
        <ul class="clearfix">
          ...
          <li>
            <router-link to="current">活期</router-link>
          </li>
          <li>
            <a href="#">安全保障</a>
          </li>
          <li>
            <router-link to="help" tag="a">帮助</router-link>
            
          </li>
          <li>
            <router-link to="product">我的账户</router-link>
          </li>
          <li>
            <router-link to="register">注册</router-link>
            <li>
              <router-link to="loginV">登录</router-link>
